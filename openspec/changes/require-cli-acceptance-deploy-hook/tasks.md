...
- [ ] 4.1 Keep the implementation at or below 15 files and 900 added/deleted lines excluding OpenSpec planning artifacts; stop and report for human boundary review if the limit would be exceeded.
