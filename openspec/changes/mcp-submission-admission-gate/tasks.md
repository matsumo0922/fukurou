...
- [x] 2.9 `OneShotLlmRunner` が生成する auditor だけ `retainsProcessTreeProof = true` を渡す。Reflection / EVALUATION_REPORT / daemon pre-filter は既定の false のままとし、phase 終了で解放されることを確認する
