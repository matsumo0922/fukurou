# Durable Receipt Eligibility Specification

## Purpose

Define the durable receipt authority and transactional admission boundary that make realtime paper resting-entry fills causal and fail closed while preserving risk-reducing handling.
