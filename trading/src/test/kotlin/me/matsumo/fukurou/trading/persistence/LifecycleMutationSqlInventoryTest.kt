...
class LifecycleMutationSqlInventoryTest {
    ...
    fun productionCallersAcquireLifecycleTokenBeforeSingleBulkUpsertAndEmbeddedMutationEntrypoints() {
        ...
        val cases = listOf(
            ...
            OrderedLifecycleCall("trading/src/main/kotlin/me/matsumo/fukurou/trading/persistence/ExposedLlmLaunchReservationRepository.kt", "override suspend fun recoverStaleExecutionClaim(", "acquireGapPopulationGenerationTokenForEntity", "RECOVER_STALE_LLM_EXECUTION_CLAIM_SQL"),
            OrderedLifecycleCall("trading/src/main/kotlin/me/matsumo/fukurou/trading/persistence/ExposedLlmLaunchReservationRepository.kt", "override suspend fun recoverStaleExecutionClaims(", "acquireGapPopulationGenerationTokenForEntity", "batchRecoverySql("),
